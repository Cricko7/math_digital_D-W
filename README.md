...
- Python и другие (javascript, C++ и т.д.)
...
> 2) Перед выполнением дальнейших инструкции убедитесь в наличии актуальной версии Python (я использовал версию 3.12.0), а также проверьте утилиту pip.
> 3) Для ВТОРОГО пункта пишем в командной строке (CMD):
...
1. На этой же страничке с github-репозиторием (где вы сейчас находитесь и читаете инструкцию) скачиваем архив с данным проектом (ПУТЬ: code --> download archive ZIP).
